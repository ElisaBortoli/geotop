                                      ...
                                      InitTools *itools)
{
    ...
    //std::cerr << "(1) par->plot_discharge_with_Dt_integration.size() = " << par->plot_discharge_with_Dt_integration.size() << std::endl;
    par->plot_discharge_with_Dt_integration.resize(2, 0);
    // std::cerr << "(2) par->plot_discharge_with_Dt_integration.size() = " << par->plot_discharge_with_Dt_integration.size() << std::endl;
...
// --------------------------------------------------------------------------------------------------------------------
    ...
    //   --------------------------------------------------------------------------------------------------------------------
    npoints = 0;
    //std::cerr << "lKeywordString.size() = " << lKeywordString.size() << std::endl;
...
//---------------------------------------------------------------------------------------------------------------------
    ...
    {
        nmeteo_stations = (long)getDoubleValueWithDefault(lConfigStore, "NumberOfMeteoStations",
                                                          geotop::input::gDoubleNoValue, false);
    }
                      ...
                      Par *par)
{
    ...
    if (mio::FileUtils::fileExists(string(name) + string(textfile)))
    {
                              ...
                              std::vector<std::string> key_header)
{
    ...
    if (mio::FileUtils::fileExists(name + string(textfile)))
    {
        temp = name + textfile;
