...
#stop("HERE")
#####
suffixes <- c("-version-2.0","-version-2.1","-version-3.0","")
...
if (input$version_2.0==FALSE) suffixes_ <- suffixes_[suffixes_!="-version-2.0"]
if (input$version_2.1==FALSE) suffixes_ <- suffixes_[suffixes_!="-version-2.1"]
if (input$version_3.0==FALSE) suffixes_ <- suffixes_[suffixes_!="-version-3.0"]
...
###	residuals <- data-data[,"-version-2.0"]
