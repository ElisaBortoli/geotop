...
checkboxInput(inputId = "version_2.0",label = strong("version-2.0"),value = TRUE),
checkboxInput(inputId = "version_2.1",label = strong("version-2.1"),value = TRUE),
checkboxInput(inputId = "version_3.0",label = strong("version-3.0"),value = FALSE),
#checkboxInput(inputId = "METEOIO_OFF",label = strong("METEOIO-OFF"),value = FALSE),
